<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	...
	<div class="label">
		...
		<label>
			...
			<?php _e('Import', 'theme_support_comre') ?>

		</label>

		<div class="description">

			<p><?php _e('Import Options', 'theme_support_comre') ?></p>
	...
	<div class="field">
		...
		<div class="input">
			...
			<div class="buttons">
				...
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php _e('Import', 'theme_support_comre') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	...
	<div class="label">
		...
		<label>
			...
			<?php _e('Export', 'theme_support_comre') ?>

		</label>

		<div class="description">

			<p><?php _e('Export Options', 'theme_support_comre') ?></p>
	...
	<div class="field">
		...
		<div class="input">
			...
			<div class="buttons">
				...
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php _e('Export', 'theme_support_comre') ?>" />
