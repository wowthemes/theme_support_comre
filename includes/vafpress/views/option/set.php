				...
				<form id="vp-option-form" class="vp-option-form vp-js-option-form" method="POST">
					...
					<div id="vp-submit-top" class="vp-submit top">
						...
						<div class="inner">
							...
							<input class="vp-save vp-button button button-primary" type="submit" value="<?php _e('Save Changes', 'theme_support_comre'); ?>" />

							<p class="vp-js-save-loader save-loader" style="display: none;"><img src="<?php VP_Util_Res::img_out('ajax-loader.gif', ''); ?>" /><?php _e('Saving Now', 'theme_support_comre'); ?></p>
