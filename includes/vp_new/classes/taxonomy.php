...
add_action('admin_head', array('WPAlchemy_Taxonomy', '_global_head'));



add_action('admin_footer', array('WPAlchemy_Taxonomy', '_global_foot'));
...
printr($this->template);
...

	{
		...
		if ( $pagenow !== 'edit-tags.php' && $pagenow !== 'term.php' ) return;
