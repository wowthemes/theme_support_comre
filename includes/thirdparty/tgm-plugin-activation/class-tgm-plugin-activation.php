	...
	class TGM_Plugin_Activation {
		...
		public function __construct() {
			...
			$this->strings = array(
				...
				'page_title'                      => __( 'Install Required Plugins', 'theme_support_comre' ),

				'menu_title'                      => __( 'Install Plugins', 'theme_support_comre' ),

				'installing'                      => __( 'Installing Plugin: %s', 'theme_support_comre' ),

				'oops'                            => __( 'Something went wrong.', 'theme_support_comre' ),
				...
				'return'                          => __( 'Return to Required Plugins Installer', 'theme_support_comre' ),

				'dashboard'                       => __( 'Return to the dashboard', 'theme_support_comre' ),

				'plugin_activated'                => __( 'Plugin activated successfully.', 'theme_support_comre' ),

				'activated_successfully'          => __( 'The following plugin was activated successfully:', 'theme_support_comre' ),

				'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'theme_support_comre' ),

				'dismiss'                         => __( 'Dismiss this notice', 'theme_support_comre' ),
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		protected function _gather_plugin_data() {
			...
			foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
				...
				if ( isset( $plugin['external_url'] ) ) {
					...
					$table_data[$i]['source'] = __( 'External Link', 'theme_support_comre' );
				...
				elseif ( isset( $plugin['source'] ) ) {
					...
					if ( preg_match( '|^http(s)?://|', $plugin['source'] ) )
						...
						$table_data[$i]['source'] = __( 'Private Repository', 'theme_support_comre' );

					/** The plugin is pre-packaged with the theme */

					else

						$table_data[$i]['source'] = __( 'Pre-Packaged', 'theme_support_comre' );
				...
				/** The plugin is from the WordPress repository */
					...
					$table_data[$i]['source'] = __( 'WordPress Repository', 'theme_support_comre' );

				}



				$table_data[$i]['type'] = $plugin['required'] ? __( 'Required', 'theme_support_comre' ) : __( 'Recommended', 'theme_support_comre' );



				if ( ! isset( $installed_plugins[$plugin['file_path']] ) )

					$table_data[$i]['status'] = sprintf( '%1$s', __( 'Not Installed', 'theme_support_comre' ) );

				elseif ( is_plugin_inactive( $plugin['file_path'] ) )

					$table_data[$i]['status'] = sprintf( '%1$s', __( 'Installed But Not Activated', 'theme_support_comre' ) );
		...
		public function no_items() {
			...
			printf( __( 'No plugins to install or activate. <a href="%1$s" title="Return to the Dashboard">Return to the Dashboard</a>', 'theme_support_comre' ), admin_url() );
		...
		public function get_columns() {
			...
			$columns = array(
				...
				'plugin' => __( 'Plugin', 'theme_support_comre' ),

				'source' => __( 'Source', 'theme_support_comre' ),

				'type'   => __( 'Type', 'theme_support_comre' ),

				'status' => __( 'Status', 'theme_support_comre' )
		...
		public function get_bulk_actions() {
			...
			$actions = array(
				...
				'tgmpa-bulk-install'  => __( 'Install', 'theme_support_comre' ),

				'tgmpa-bulk-activate' => __( 'Activate', 'theme_support_comre' ),
	...
	if ( ! class_exists( 'TGM_Bulk_Installer' ) ) {
		...
		class TGM_Bulk_Installer extends WP_Upgrader {
			...
			public function install_strings() {
				...
				$this->strings['no_package']          = __( 'Install package not available.', 'theme_support_comre' );

				$this->strings['downloading_package'] = __( 'Downloading install package from <span class="code">%s</span>&#8230;', 'theme_support_comre' );

				$this->strings['unpack_package']      = __( 'Unpacking the package&#8230;', 'theme_support_comre' );

				$this->strings['installing_package']  = __( 'Installing the plugin&#8230;', 'theme_support_comre' );

				$this->strings['process_failed']      = __( 'Plugin install failed.', 'theme_support_comre' );

				$this->strings['process_success']     = __( 'Plugin installed successfully.', 'theme_support_comre' );
			...
			public function activate_strings() {
				...
				$this->strings['activation_failed']  = __( 'Plugin activation failed.', 'theme_support_comre' );

				$this->strings['activation_success'] = __( 'Plugin activated successfully.', 'theme_support_comre' );
		...
		class TGM_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
			...
			public function add_strings() {
				...
				if ( TGM_Plugin_Activation::$instance->is_automatic ) {
					...
					$this->upgrader->strings['skin_upgrade_start']        = __( 'The installation and activation process is starting. This process may take a while on some hosts, so please be patient.', 'theme_support_comre' );

					$this->upgrader->strings['skin_update_successful']    = __( '%1$s installed and activated successfully.', 'theme_support_comre' ) . ' <a onclick="%2$s" href="#" class="hide-if-no-js"><span>' . __( 'Show Details', 'theme_support_comre' ) . '</span><span class="hidden">' . __( 'Hide Details', 'theme_support_comre' ) . '</span>.</a>';

					$this->upgrader->strings['skin_upgrade_end']          = __( 'All installations and activations have been completed.', 'theme_support_comre' );

					$this->upgrader->strings['skin_before_update_header'] = __( 'Installing and Activating Plugin %1$s (%2$d/%3$d)', 'theme_support_comre' );
				...
				/** Default installation strings */
					...
					$this->upgrader->strings['skin_upgrade_start']        = __( 'The installation process is starting. This process may take a while on some hosts, so please be patient.', 'theme_support_comre' );

					$this->upgrader->strings['skin_update_failed_error']  = __( 'An error occurred while installing %1$s: <strong>%2$s</strong>.', 'theme_support_comre' );

					$this->upgrader->strings['skin_update_failed']        = __( 'The installation of %1$s failed.', 'theme_support_comre' );

					$this->upgrader->strings['skin_update_successful']    = __( '%1$s installed successfully.', 'theme_support_comre' ) . ' <a onclick="%2$s" href="#" class="hide-if-no-js"><span>' . __( 'Show Details', 'theme_support_comre' ) . '</span><span class="hidden">' . __( 'Hide Details', 'theme_support_comre' ) . '</span>.</a>';

					$this->upgrader->strings['skin_upgrade_end']          = __( 'All installations have been completed.', 'theme_support_comre' );

					$this->upgrader->strings['skin_before_update_header'] = __( 'Installing Plugin %1$s (%2$d/%3$d)', 'theme_support_comre' );
			...
			public function bulk_footer() {
				...
				if ( empty( $complete ) ) {
					...
					echo '<p>' .  sprintf( TGM_Plugin_Activation::$instance->strings['complete'], '<a href="' . admin_url() . '" title="' . __( 'Return to the Dashboard', 'theme_support_comre' ) . '">' . __( 'Return to the Dashboard', 'theme_support_comre' ) . '</a>' ) . '</p>';
